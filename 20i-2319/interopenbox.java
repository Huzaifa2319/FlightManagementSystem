...
public class interopenbox extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					interopenbox frame = new interopenbox();
	 ...
	 */
	public interopenbox() {
		setTitle("Flight Opened Successfully");
		...
		JLabel lblNewLabel = new JLabel("Flight Opened Successfully");
